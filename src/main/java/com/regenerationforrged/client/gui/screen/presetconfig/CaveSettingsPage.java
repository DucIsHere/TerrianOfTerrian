package com.regenerationforrged.client.gui.screen.presetconfig;

import java.util.Optional;

import net.minecraft.client.gui.components.CycleButton;
import net.minecraft.network.chat.Component;
import com.regenerationforrged.client.data.RTFTranslationKeys;
import com.regenerationforrged.client.gui.screen.page.LinkedPageScreen.Page;
import com.regenerationforrged.client.gui.screen.presetconfig.PresetListPage.PresetEntry;
import com.regenerationforrged.client.gui.widget.Slider;
import com.regenerationforrged.data.worldgen.preset.settings.CaveSettings;
