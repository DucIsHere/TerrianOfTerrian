package com.regenerationforrged.client.gui.screen.page;

import net.minecraft.client.gui.components.AbstractWidget;
import net.minecraft.client.gui.screens.Screen;
import com.regenerationforrged.client.gui.ColumnAlignment;
import com.regenerationforrged.client.gui.screen.page.LinkedPageScreen.Page;
import com.regenerationforrged.client.gui.widget.WidgetList;
